...
$allowedPages = ['dashboard', 'profile', 'users', 'settings', 'games', 'kelas', 'murid', 'murid_kelas', 'reminder_categories', 'reminders', 'roles', 'pj_kelas', 'pj_murid_kelas', 'pj_reminder', 'murid_reminder', 'murid_kelas_murid', 'login', 'logout', 'register'];
$publicPages   = ['login','register','404']; // Halaman yang tidak butuh login
...
switch ($page) {
    ...
    case 'games':
        ...
        break;
    case 'kelas':
        require_once 'pages/kelas/index.php';
        break;
    case 'murid':
        require_once 'pages/murid/index.php';
        break;
    case 'murid_kelas':
        require_once 'pages/murid_kelas/index.php';
        break;
    case 'reminder_categories':
        require_once 'pages/reminder_categories/index.php';
        break;
    case 'reminders':
        require_once 'pages/reminders/index.php';
        break;
    case 'roles':
    ...
    case 'pj_kelas':
        ...
        break;
    case 'pj_murid_kelas':
        require_once 'pages/pj_murid_kelas/index.php';
        break;
    case 'pj_reminder':
        require_once 'pages/pj_reminder/index.php';
        break;
    case 'murid_reminder':
        require_once 'pages/murid_reminder/index.php';
        break;
    case 'murid_kelas_murid':
        require_once 'pages/murid_kelas_murid/index.php';
        break;
    default:
